                ...
                <div className="p-5 space-y-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className={`flex-1 py-2 ${darkMode ? 'bg-slate-700 hover:bg-slate-600' : 'bg-slate-100 hover:bg-slate-200'} rounded-lg text-[10px] font-bold ${darkMode ? 'text-pink-400' : 'text-pink-600'} transition-colors`}
                        >
                            VIP 549K
                        </button>
                    </div>
