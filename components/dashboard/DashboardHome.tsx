...
const ALL_TOOLS: ToolItem[] = [
  ...
  { id: 'video-pipeline', name: 'Video Pipeline', desc: 'Quản lý kênh, đăng bài', icon: Video, type: 'tool' },
  { id: 'seo-tool', name: 'SEO Tool', desc: 'Tối ưu YouTube SEO', icon: TrendingUp, type: 'tool' },
  { id: 'thumbnail-ai', name: 'Thumbnail AI', desc: 'Tạo ảnh bìa viral', icon: Image, type: 'page', route: '/tools/thumbnail-ai' },
  { id: 'rival-scanner', name: 'Rival Scanner', desc: 'Phân tích đối thủ', icon: BarChart3, type: 'tool' },
  { id: 'intelligence-hub', name: 'Intelligence Hub', desc: 'Phân tích xu hướng', icon: Sparkles, type: 'tool' },
...
const TOOLS_BY_TIER: Record<string, {
  ...
  STARTER: {
    ...
    toolIds: ['niche-radar', 'script-studio', 'video-pipeline', 'seo-tool', 'thumbnail-ai', 'rival-scanner', 'marketplace', 'affiliate'],
  },
  CREATOR: {
    tier: 'Creator',
    ...
    toolIds: ['niche-radar', 'script-studio', 'video-pipeline', 'koda-studio', 'intelligence-hub', 'multilingual-studio', 'ai-coach', 'marketplace', 'affiliate'],
  },
  FACTORY: {
    tier: 'Factory',
    ...
    toolIds: ['niche-radar', 'script-studio', 'video-pipeline', 'koda-studio', 'koda-novel', 'koda-factory', 'intelligence-hub', 'multilingual-studio', 'marketplace', 'affiliate'],
  },
  AGENCY: {
    tier: 'Agency',
    color: 'text-cyan-400',
    ...
    toolIds: ['niche-radar', 'script-studio', 'video-pipeline', 'koda-studio', 'koda-novel', 'koda-factory', 'intelligence-hub', 'multilingual-studio', 'team-dashboard', 'marketplace', 'affiliate'],
  },
  ENTERPRISE: {
    tier: 'Enterprise',
    color: 'text-rose-400',
    ...
    toolIds: ['niche-radar', 'script-studio', 'video-pipeline', 'koda-studio', 'koda-novel', 'koda-factory', 'intelligence-hub', 'multilingual-studio', 'team-dashboard', 'api-access', 'marketplace', 'affiliate'],
  },
};
