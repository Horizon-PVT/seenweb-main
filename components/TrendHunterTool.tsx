...
interface TrendHunterToolProps {
    onBack?: () => void;
}

export default function TrendHunterTool({ onBack }: TrendHunterToolProps) {
    ...
    return (
        <div className="h-full bg-black text-gray-300 font-mono flex flex-col overflow-hidden selection:bg-cyan-900 selection:text-cyan-100 relative">

            {/* 0. CRT EFFECT OVERLAY */}
            <div className="pointer-events-none absolute inset-0 z-[100] opacity-10 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(255,0,0,0.06),rgba(0,255,0,0.02),rgba(0,0,255,0.06))] bg-[length:100%_2px,3px_100%]"></div>
            ...
            <header className="px-6 py-3 border-b border-gray-800 bg-[#050505] z-50 flex-shrink-0 flex justify-between items-center text-xs tracking-wider uppercase">
                <div className="flex items-center gap-6">
                    {onBack && (
                        <button onClick={onBack} className="text-gray-500 hover:text-cyan-500 transition-colors flex items-center gap-2 font-bold">
                ...
                <div className="flex items-center gap-6 font-bold hidden md:flex">
            ...
            {/* 2. MAIN GRID LAYOUT */}
            <div className="flex-1 grid grid-cols-1 md:grid-cols-12 gap-0 overflow-hidden divide-x divide-gray-800">

                {/* COL 1: DATA FEED (Left) - Denser, High Contrast */}
                <div className="col-span-1 md:col-span-3 bg-[#020202] flex flex-col relative md:block hidden">
                    ...
                    {/* Dense List */}
                    <div className="flex-1 overflow-y-auto p-0 scrollbar-thin scrollbar-thumb-gray-800 hover:scrollbar-thumb-gray-600 h-[calc(100vh-140px)]">
                ...
                <div className="col-span-1 md:col-span-5 bg-[#050505] relative flex flex-col">
                    {/* Grid Background */}
                    ...
                    {!selectedTrend ? (
                        <div className="flex-1 flex flex-col items-center justify-center text-gray-800 p-8 text-center z-10">
                            ...
                            <button
                                onClick={handleScan}
                                className="mt-4 px-4 py-2 border border-cyan-900/50 text-cyan-500 text-xs font-bold uppercase md:hidden"
                            >
                                [ SCAN NETWORK ]
                            </button>
                            <p className="text-xs text-gray-800 font-mono hidden md:block">Select data vector from feed</p>
                        </div>
                    ) : (
                ...
                <div className="col-span-1 md:col-span-4 bg-[#0a0a0f] flex flex-col border-l border-gray-800 h-1/2 md:h-full overflow-hidden">
