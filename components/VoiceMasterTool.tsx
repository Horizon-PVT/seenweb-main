...
import { Wand2, Youtube, Upload, Play, Download, Check, Edit3, Volume2, ArrowRight, Loader2, Video as VideoIcon, ArrowLeft } from 'lucide-react';

interface VoiceMasterToolProps {
    onBack?: () => void;
}

export default function VoiceMasterTool({ onBack }: VoiceMasterToolProps) {
    ...
    return (
        <div className="h-full bg-black text-white selection:bg-[#CDAD5A] selection:text-black flex flex-col overflow-y-auto">
            {/* Header */}
            <header className="sticky top-0 w-full z-50 border-b border-gray-800 bg-black/80 backdrop-blur-md shrink-0">
                <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="font-bold text-xl tracking-tight hidden sm:inline">Voice Master <span className="text-[#CDAD5A] text-xs px-2 py-0.5 border border-[#CDAD5A] rounded-full ml-2">BETA</span></span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-6 text-sm">
                        ...
                        <div className="w-8 h-[1px] bg-gray-800 hidden sm:block"></div>
            ...
            <main className="flex-grow pt-10 pb-20 max-w-5xl mx-auto px-4 w-full">

                {/* STEP 1: INPUT */}
                {step === 1 && (
                    <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
                        <div className="text-center mb-12">
                            <h1 className="text-4xl md:text-5xl font-black mb-6 bg-gradient-to-r from-white via-gray-200 to-gray-500 bg-clip-text text-transparent">
                                AI DUBBING STUDIO
                            </h1>
                        ...
                        <div className="bg-[#111] border border-gray-800 rounded-3xl p-8 max-w-3xl mx-auto shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="flex gap-3 flex-col sm:flex-row">
                                ...
                                <button
                                    ...
                                    className="bg-[#CDAD5A] hover:bg-[#b09348] text-black font-bold px-8 py-3 sm:py-0 rounded-xl flex items-center justify-center transition disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_20px_rgba(205,173,90,0.3)] hover:shadow-[0_0_30px_rgba(205,173,90,0.5)]"
                                >
                ...
                {/* STEP 2: EDITOR */}
                {step === 2 && (
                    <div className="animate-in zoom-in-95 duration-500 flex flex-col h-[70vh]">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="bg-white text-black px-4 md:px-6 py-2 rounded-full font-bold hover:scale-105 transition flex items-center text-sm md:text-base"
                            >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 overflow-hidden min-h-0">
                            ...
                            <div className="lg:col-span-1 bg-[#111] rounded-2xl border border-gray-800 p-4 flex flex-col overflow-y-auto">
                                {/* If it's a Youtube link, we can embed. For now just show info */}
                                <div className="aspect-video bg-black rounded-xl mb-4 flex items-center justify-center border border-gray-800 shrink-0">
                                    <VideoIcon className="w-16 h-16 text-gray-700" />
                                </div>
                                <p className="text-gray-400 text-sm mb-2 break-all">Video Gốc: <span className="text-white block">{videoUrl}</span></p>
                                ...
                                <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin scrollbar-thumb-[#CDAD5A]/20">
                                    {segments.map((seg, idx) => (
                                        <div key={idx} className="flex gap-4 group">
                                            <div className="w-24 text-xs font-mono text-gray-600 pt-3 text-right shrink-0">
                ...
                {step === 3 && (
                    <div className="text-center animate-in zoom-in duration-500 max-w-4xl mx-auto pt-10">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Video Của Bạn Đã Sẵn Sàng! </h2>
                        ...
                        <div className="flex justify-center gap-4 flex-col sm:flex-row">
                            <a
                                href={finalVideoUrl}
                                download
                                className="bg-[#CDAD5A] hover:bg-[#b09348] text-black font-bold px-8 py-3 rounded-xl flex items-center justify-center transition shadow-lg"
                            >
