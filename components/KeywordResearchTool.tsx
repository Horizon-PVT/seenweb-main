...
export default function KeywordResearchTool({ onBack }: KeywordResearchToolProps) {
    // State
    ...
    return (
        <div className="font-sans text-gray-300 selection:bg-[#CDAD5A] selection:text-black">
            ...
            <div className="container mx-auto max-w-7xl">
                ...
                {onBack && (
                    <button
                        onClick={onBack}
                        className="mb-6 flex items-center text-sm text-gray-500 hover:text-white transition-colors"
                    >
