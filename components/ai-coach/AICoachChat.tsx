...
export default function AICoachChat() {
    ...
    return (
        <>
            ...
            {/* CHAT WIDGET */}
            <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 9999, display: 'flex', justifyContent: 'center', paddingBottom: 24, paddingLeft: '256px' }}>
                <div style={{ width: '100%', maxWidth: 760, padding: '0 16px' }}>
