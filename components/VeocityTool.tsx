...
export default function VeocityTool({ onBack }: VeocityToolProps) {
    ...
    return (
        <div className="h-full bg-[#0a0a0a] text-gray-200 font-sans selection:bg-red-900 selection:text-white overflow-hidden flex flex-col">
            {/* BROADCAST HEADER */}
            <header className="h-16 bg-black border-b border-red-900/30 flex items-center justify-between px-6 z-50 relative overflow-hidden shrink-0">
                ...
                <div className="flex items-center gap-6">
                    {onBack && (
                        <button onClick={onBack} className="text-gray-500 hover:text-white transition-colors flex items-center gap-2 group">
            ...
            <main className="flex-grow flex p-6 gap-6 overflow-hidden relative">
                ...
                {isLoading ? (
                    ...
                    <>
                        {phase === 'setup' && (
                            <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 z-10 overflow-y-auto">
                        ...
                        {phase === 'timeline' && (
                            <div className="flex-grow flex flex-col gap-6 animate-in slide-in-from-right-8 duration-500 z-10 w-full max-w-7xl mx-auto overflow-hidden">
                                <div className="bg-gray-900/90 border-l-4 border-l-yellow-500 border border-gray-800 p-4 rounded-r shadow-lg flex flex-col md:flex-row gap-4 items-start shrink-0">
                                ...
                                <div className="border-t border-gray-800 pt-4 flex justify-between items-center shrink-0">
