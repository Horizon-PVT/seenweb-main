...
export default function AffiliatePartnerPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            <Head>
                <title>Affiliate & Partner - SeenYT</title>
            </Head>
                ...
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-xl font-black text-white">Affiliate & Partner</h1>
                                <p className="text-sm text-gray-500">Chương trình giới thiệu & đại lý</p>
                            </div>
                        </div>
                    </div>
