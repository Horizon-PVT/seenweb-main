...
export default function RivalScannerPage() {
    ...
    return (
        <div className="min-h-screen bg-[#050a05] text-[#00ff41] font-mono overflow-x-hidden selection:bg-[#003b00] selection:text-[#00ff41]">
            <Head>
                <title>RIVAL SCANNER | MILITARY GRADE INTELLIGENCE</title>
            </Head>
            ...
            {/* HEADER */}
            <header className="fixed top-0 left-0 right-0 h-14 bg-[#0a140a] border-b border-[#003b00] flex items-center justify-between px-6 z-40">
                <div className="flex items-center gap-4">
                    <Link href="/?tool=research" className="flex items-center gap-2 hover:bg-[#003b00] px-3 py-1 rounded transition-colors text-xs font-bold tracking-widest uppercase">
            ...
            {/* MAIN CONTENT */}
            <main className="pt-20 px-6 pb-12 max-w-7xl mx-auto min-h-screen flex flex-col">
