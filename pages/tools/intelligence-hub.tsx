    ...
    if (!isReady) {
        return (
            <div className="min-h-screen bg-[#050b14] flex items-center justify-center">
                <div className="animate-pulse text-blue-400 font-bold tracking-widest">LOADING...</div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[#050b14] text-white font-sans overflow-x-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_#0a1628_0%,_#050b14_60%)]"></div>
            ...
            {/* Header */}
            <header className="fixed top-0 left-0 right-0 h-16 bg-[#050b14]/90 backdrop-blur border-b border-white/10 flex items-center justify-between px-6 z-50">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-sm font-black tracking-[0.2em] text-white">INTELLIGENCE HUB</h1>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    <Globe size={14} className="text-gray-500" />
                    <span className="text-gray-400 text-xs font-mono">{market === 'VN' ? 'VIETNAM MARKET' : 'US MARKET'}</span>
                </div>
            </header>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="bg-white/5 border border-green-500/20 rounded-xl p-6">
                                                <h4 className="text-green-400 font-bold text-sm uppercase tracking-wider mb-4 flex items-center gap-2">
                                                    <Shield size={14} /> Competitor Strengths
                                                </h4>
