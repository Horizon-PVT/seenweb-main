...
export default function AffiliateLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white">
      ...
      <section className="relative py-32 px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-12 text-gray-200 drop-shadow-lg">
            Đã có <span className="text-cyan-400 font-bold text-4xl">{affiliateCount.toLocaleString('vi-VN')}+</span> creator tham gia và kiếm tiền ổn định từ SeenYT!
          </p>
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            ...
            <p className="mt-4 text-gray-400 text-center text-lg">Xem demo SeenYT tạo video AI chỉ trong 60 giây!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-4 gap-8">
          <div className="text-center">
            <img src="/images/affiliate/icon-step1.png" alt="Step 1" className="w-24 h-24 mx-auto mb-4" />
            <p className="font-bold">Tham gia miễn phí</p>
            <p className="text-gray-400">Đăng nhập → bật affiliate → nhận link riêng</p>
          </div>
          <div className="text-center">
            <img src="/images/affiliate/icon-step2.png" alt="Step 2" className="w-24 h-24 mx-auto mb-4" />
            <p className="font-bold">Quảng bá link</p>
            <p className="text-gray-400">YouTube, TikTok, FB group, blog...</p>
          </div>
          <div className="text-center">
            <img src="/images/affiliate/icon-step3.png" alt="Step 3" className="w-24 h-24 mx-auto mb-4" />
            <p className="font-bold">User mua qua link</p>
            <p className="text-gray-400">Bạn nhận hoa hồng tự động</p>
          </div>
          <div className="text-center">
            <img src="/images/affiliate/icon-step4.png" alt="Step 4" className="w-24 h-24 mx-auto mb-4" />
            ...
            {[...Array(2)].map((_, i) => (
              <div key={i} className="flex" style={{ gap: '2rem' }}>
                <div className="min-w-[350px] bg-gray-800 p-6 rounded-xl text-center">
                  <img src="/images/affiliate/testimonial1.jpg" alt="Minh Hải" className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" />
                ...
                <div className="min-w-[350px] bg-gray-800 p-6 rounded-xl text-center">
                  <img src="/images/affiliate/testimonial2.jpg" alt="Lan Anh" className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" />
                ...
                <div className="min-w-[350px] bg-gray-800 p-6 rounded-xl text-center">
                  <img src="/images/affiliate/testimonial3.jpg" alt="Tuấn Kiệt" className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" />
                ...
                <div className="min-w-[350px] bg-gray-800 p-6 rounded-xl text-center">
                  <img src="/images/affiliate/testimonial1.jpg" alt="Vũ Long" className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" />
                ...
                <div className="min-w-[350px] bg-gray-800 p-6 rounded-xl text-center">
                  <img src="/images/affiliate/testimonial2.jpg" alt="Hương Ly" className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" />
                ...
                <div className="min-w-[350px] bg-gray-800 p-6 rounded-xl text-center">
                  <img src="/images/affiliate/testimonial3.jpg" alt="Đức Anh" className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" />
      ...
      <section className="py-16 px-6">
        <h2 className="text-4xl font-bold text-center mb-12">Hướng Dẫn Quảng Bá Hiệu Quả Theo Nền Tảng</h2>
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          <div className="bg-gray-800 p-8 rounded-xl">
            ...
            <a href="/images/affiliate/banner-yt.jpg" download className="block text-center bg-red-600 py-2 rounded hover:bg-red-700">
              Tải Banner YouTube
            </a>
          </div>
          ...
          <div className="bg-gray-800 p-8 rounded-xl">
            ...
            <a href="/images/affiliate/banner-fb.jpg" download className="block text-center bg-blue-600 py-2 rounded hover:bg-blue-700">
              Tải Banner Facebook
            </a>
          </div>
          ...
          <div className="bg-gray-800 p-8 rounded-xl">
            ...
            <a href="/images/affiliate/banner-tiktok.jpg" download className="block text-center bg-pink-600 py-2 rounded hover:bg-pink-700">
